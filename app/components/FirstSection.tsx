			...
			<div className="w-full flex flex-col max-2xl:flex-col-reverse gap-10 items-start">
			    <div className="w-[80%] max-2xl:w-1/2 max-lg:w-[70%] max-sm:w-[90%]">
			    	...
			    	<button className="flex items-center gap-7 bg-black text-white px-14 py-4 max-md:px-10 max-md:py-3 max-sm:px-8 max-sm:py-2 rounded-full mt-6">
			    	    Купить сейчас
			    		<Image src={'/icons/to-right-icon.png'} className="rotate-90" width={12} height={10} alt=""/>
			    	</button>
			    </div>
			    <div className="mt-10 max-2xl:mt-0 w-full">
			    	<p className="text-lg max-2xl:text-2xl max-xl:text-xl font-semibold">You mignt love Ice cream:</p>
					{/* <Swiper
			    	...
			    	<div className="flex items-center gap-5">
			    	    <div className="grid grid-cols-2 gap-5 mt-5">
                            <div className="flex gap-5 items-center shadow-lg rounded-3xl p-5 cursor-pointer z-10">
                                <Image src={'/image/ice-cream-2.png'}  width={100} height={100} alt=""/>
			    	    		<div className="flex flex-col gap-2">
                                    <p className="font-bold">Сhoco vanilla Ice Cream</p>
			    	    			<p>2 Scoops</p>
			    	    			<p className="font-black text-lg">$75</p>
			    	    		</div>
			    	    	</div>
			    	    	<div className="flex gap-5 items-center shadow-lg rounded-3xl p-5 cursor-pointer z-10">
                                <Image src={'/image/ice-cream-2.png'}  width={100} height={100} alt=""/>
			    	    ...
			    	    <div className="p-4 rounded-full shadow-xl flex items-center justify-center cursor-pointer  z-10">
                            <Image src={"/icons/to-right-icon2.png"} width={100} height={100} alt="" className="w-7 h-7"/>
			    		</div>
			    	</div>
			    </div>
			</div>
			...
			<div className="w-full flex items-start justify-between max-2xl:justify-center">
			    ...
			    <div className="w-full h-auto max-2xl:w-1/2 max-2xl:text-xl max-2xl:font-bold max-lg:font-medium max-lg:text-lg max-sm:text-base max-sm:pt-10 text-white z-10">
                    <div className="flex items-start gap-3">
                        <Image src={'/icons/Vector1.png'} width={100} height={10} alt="" className='max-sm:w-10'/>
