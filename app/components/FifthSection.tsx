...
const FifthSection: React.FC<FifthSectionSectionProps> = () => {
    return (
        <section className="mt-20">
            <h1 className="font-bold gap-4 text-center leading-tight text-5xl max-lg:text-4xl max-md:text-3xl max-sm:text-3xl tracking- font-['lepka']">
                SOME OF OUR{" "}
            ...
            <div className="grid grid-cols-3 max-xl:grid-cols-2 max-md:grid-cols-1 gap-14 max-sm:gap-7 my-6">
                <div className="p-7 shadow-2xl rounded-2xl">
                ...
                <div className="p-7 shadow-2xl rounded-2xl row-start-2 row-end-3 col-start-2 col-end-3 max-md:row-start-4 max-md:row-end-5 max-md:col-span-1">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-3xl max-xl:text-2xl font-semibold">
                                John Devson
                ...
                <div className="flex items-center justify-center col-start-2 col-end-3 row-start-1 row-end-2 max-xl:col-span-1 ">
                    <Image
