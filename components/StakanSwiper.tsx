                ...
                >
                    <SwiperSlide>
                        <div className="flex items-start justify-center">
                            <div className="bg-[#53C9ED] w-full h-[550px] max-lg:h-[400px]  max-sm:h-[250px] ease-linear duration-200 max-2xl:w-[400px] rounded-3xl max-lg:rounded-2xl flex flex-col justify-between gap-10 max-sm:gap-2 cursor-pointer items-center py-10 max-lg:py-5">
                                <div
                                ...
                                >
                                    <Image
                                        ...
                                        className={`absolute top-1/2 left-1/2 -translate-x-1/2  ease-in-out duration-200 max-xl:w-[200px] max-xl:h-[210px] max-lg:w-[170px] max-lg:h-[170px] max-sm:h-[70px] max-sm:w-[70px] -translate-y-1/2`}
                                    />
                                </div>
                            ...
                            <div className="bg-[#53C9ED] w-full h-[550px] max-lg:h-[400px]  max-sm:h-[250px] ease-linear duration-200 max-2xl:w-[400px] rounded-3xl max-lg:rounded-2xl flex flex-col justify-between gap-10 max-sm:gap-2 cursor-pointer items-center py-10 max-lg:py-5">
                                ...
                                >
                                    <Image
                                        ...
                                        className={`absolute top-1/2 left-1/2 -translate-x-1/2  ease-in-out duration-200 max-xl:w-[200px]  max-lg:w-[140px] max-sm:h-[70px] max-sm:w-[70px] -translate-y-1/2`}
                                    />
                                </div>
                                <div className="flex flex-col gap-10 max-sm:gap-3 items-center justify-center">
                                    <p
                            ...
                            <div className="bg-[#53C9ED] w-full h-[550px] max-lg:h-[400px]  max-sm:h-[250px] ease-linear duration-200 max-2xl:w-[400px] rounded-3xl max-lg:rounded-2xl flex flex-col justify-between gap-10 max-sm:gap-2 cursor-pointer items-center py-10 max-lg:py-5">
                                ...
                                >
                                    <Image
                                        ...
                                        className={`absolute top-1/2 left-1/2 -translate-x-1/2  ease-in-out duration-200 max-xl:w-[250px]  max-lg:w-[200px] max-sm:w-[100px] -translate-y-1/2`}
                                    />
                                </div>
                                <div className="flex flex-col gap-10 max-sm:gap-3 items-center justify-center">
                                    <p
                            ...
                            <div className="bg-[#53C9ED] w-full h-[550px] max-lg:h-[400px]  max-sm:h-[250px] ease-linear duration-200 max-2xl:w-[400px] rounded-3xl max-lg:rounded-2xl flex flex-col justify-between gap-10 max-sm:gap-2 cursor-pointer items-center py-10 max-lg:py-5">
                                ...
                                >
                                    <Image
                                        ...
                                        className={`absolute top-[40%] left-1/2 -translate-x-1/2  ease-in-out duration-200 max-xl:w-[250px]  max-lg:w-[200px] max-sm:w-[100px] -translate-y-1/2`}
                                    />
                                </div>
                                <div className="flex flex-col gap-10 max-sm:gap-3 items-center justify-center">
                                    <p
