...
const StanokSwiper: React.FC<SecondSectionProps> = () => {
    ...
    return (
        <section className="my-20 max-sm:mt-7 max-sm:mb-14">
            <motion.h2
                initial={"offscreen"}
                            ...
                            <div className="bg-[#53C9ED] w-full h-[550px] max-lg:h-[400px]  max-sm:h-[250px] ease-linear duration-200 max-2xl:w-[400px] rounded-3xl max-lg:rounded-2xl flex flex-col justify-between gap-10 max-sm:gap-2 cursor-pointer items-center py-10 max-lg:py-5">
                                ...
                                >
                                    <Image
                                        ...
                                        className={`absolute top-1/2 left-1/2 -translate-x-1/2  ease-in-out duration-200 max-xl:w-[170px]  max-lg:w-[130px] max-sm:w-[75px] -translate-y-1/2`}
                                    />
                                </div>
                            ...
                            <div className="bg-[#53C9ED] w-full h-[550px] max-lg:h-[400px]  max-sm:h-[250px] ease-linear duration-200 max-2xl:w-[400px] rounded-3xl max-lg:rounded-2xl flex flex-col justify-between gap-10 max-sm:gap-2 cursor-pointer items-center py-10 max-lg:py-5">
                                ...
                                >
                                    <Image
                                        ...
                                        className={`absolute top-1/2 left-1/2 -translate-x-1/2  ease-in-out duration-200 max-xl:w-[250px]  max-lg:w-[200px] max-sm:w-[150px] -translate-y-1/2`}
                                    />
                                </div>
                                <div className="flex flex-col gap-10 max-sm:gap-3 items-center justify-center">
                                    <p
                            ...
                            <div className="bg-[#53C9ED] w-full h-[550px] max-lg:h-[400px]  max-sm:h-[250px] ease-linear duration-200 max-2xl:w-[400px] rounded-3xl max-lg:rounded-2xl flex flex-col justify-between gap-10 max-sm:gap-2 cursor-pointer items-center py-10 max-lg:py-5">
                                ...
                                >
                                    <Image
                                        ...
                                        className={`absolute top-1/2 left-1/2 -translate-x-1/2  ease-in-out duration-200 max-xl:w-[170px]  max-lg:w-[130px] max-sm:w-[80px] -translate-y-1/2`}
                                    />
                                </div>
                                <div className="flex flex-col gap-10 max-sm:gap-3 items-center justify-center">
                                    <p
